...
export const AuditAction = {
  ...
  FINANCIAL_ITEM_RENEGOTIATE: "FINANCIAL_ITEM_RENEGOTIATE",
  FINANCIAL_ITEM_PREPAY: "FINANCIAL_ITEM_PREPAY",
  ...
  // Generic action aliases used by newer route modules (purchases, VAT settings)
  // that were written before domain-specific action types were added.
