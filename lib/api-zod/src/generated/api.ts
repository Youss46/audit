...
export const ListClientsResponseItem = zod.object({
  ...
  "capitalSocial": zod.number().describe('Montant du capital social en FCFA (entier). Déclenche automatiquement l\'écriture de constitution Débit 5211 \/ Crédit 1013 lors du premier renseignement.'),
  "isCapitalInitialized": zod.boolean().describe('Indique si l\'écriture de constitution du capital social a déjà été générée dans le Grand Livre. Sert de garde d\'idempotence.'),
...
export const CreateClientBody = zod.object({
  ...
  "capitalSocial": zod.number().optional().describe('Capital social initial en FCFA. Si > 0, une écriture de constitution (Dr 5211 \/ Cr 1013) est générée automatiquement.'),
  "taxRegime": zod.enum(['REEL_NORMAL', 'REEL_SIMPLIFIE', 'ENTREPRENANT', 'EXONERE']).optional(),
  "isVatRegistered": zod.boolean().optional()
})
...
export const UpdateClientBody = zod.object({
  ...
  "contactName": zod.string().optional(),
  "annualTurnover": zod.number().optional(),
  "capitalSocial": zod.number().optional().describe('Capital social en FCFA. Si > 0 et que l\'écriture de constitution n\'a pas encore été générée, elle le sera automatiquement.'),
  "taxRegime": zod.enum(['REEL_NORMAL', 'REEL_SIMPLIFIE', 'ENTREPRENANT', 'EXONERE']).optional(),
  "isVatRegistered": zod.boolean().optional(),
  "missionStatus": zod.enum(['en_attente', 'en_cours', 'anomalie', 'valide', 'visa_emis']).optional()
})
