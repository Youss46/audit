...
export const ListTransactionsResponseItem = zod.object({
  ...
  "source": zod.enum(['pme_entry', 'ocr_entry', 'manual_cabinet', 'settlement', 'caisse_closure', 'closing_result', 'a_nouveaux', 'vat_liquidation', 'depreciation_closing', 'capital_constitution', 'purchase', 'purchase_settlement']),
...
export const CreateTransactionBody = zod.object({
  ...
  "mobileMoneyAccountId": zod.number().nullish().describe('Optional when paymentMethod is \"mobile_money\". When provided, the journal line uses the provider-specific Classe 55 sub-account (552100 Orange Money, 552200 Wave, etc.) instead of the generic \"552\".'),
...
export const SettleTransactionBody = zod.object({
  ...
  "cashRegisterId": zod.number().nullish().describe('Required when paymentMethod is \"especes\" (module P5 Caisse Terrain).'),
  "mobileMoneyAccountId": zod.number().nullish().describe('Optional when paymentMethod is \"mobile_money\". When provided, the settlement journal line uses the provider-specific Classe 55 sub-account instead of the generic \"552\".')
})
