 ...
 *   • ~180 comptes Classes 1 à 8 avec leur type (accountType)
 *   • ~30 catégories de transactions (transaction_categories) dérivées des
 *     constantes PURCHASE_CATEGORIES et CATEGORY_RULES du moteur comptable
 *
...
const COMPTES: {
  ...
  { accountNumber: "552100", name: "Orange Money",                                            accountClass: 5, accountType: "TRESORERIE" },
  { accountNumber: "552200", name: "Wave",                                                    accountClass: 5, accountType: "TRESORERIE" },
  ...
  { accountNumber: "571100", name: "Caisse Pompistes (compte collectif)",                     accountClass: 5, accountType: "TRESORERIE" },
  ...
  { accountNumber: "6261",   name: "Frais de télécommunications",                             accountClass: 6, accountType: "CHARGE" },
  { accountNumber: "6271",   name: "Publicité et relations publiques",                        accountClass: 6, accountType: "CHARGE" },
  { accountNumber: "628",    name: "Autres charges externes",                                 accountClass: 6, accountType: "CHARGE" },
...
// ---------------------------------------------------------------------------
// Dérivées des constantes PURCHASE_CATEGORIES + CATEGORY_RULES du moteur
// comptable. Servent de référentiel DB que le Cabinet peut étendre.
...
const CATEGORIES: {
  ...
  { key: "achat_marchandises",    displayName: "Achats de marchandises",                    defaultAccountNumber: "601",    defaultTvaRate: 18, vatEligible: true,  transactionType: "depense", isHidden: false },
  { key: "achat_matieres",        displayName: "Matières premières / consommables",          defaultAccountNumber: "6011",   defaultTvaRate: 18, vatEligible: true,  transactionType: "depense", isHidden: false },
  { key: "carburant",             displayName: "Carburant",                                  defaultAccountNumber: "6051",   defaultTvaRate: 18, vatEligible: true,  transactionType: "depense", isHidden: false },
  { key: "electricite_eau",       displayName: "Eau / Électricité / Énergie",                defaultAccountNumber: "6052",   defaultTvaRate: 18, vatEligible: true,  transactionType: "depense", isHidden: false },
  { key: "fournitures_bureau",    displayName: "Fournitures de bureau",                      defaultAccountNumber: "6054",   defaultTvaRate: 18, vatEligible: true,  transactionType: "depense", isHidden: false },
  { key: "fournitures_entretien", displayName: "Produits d'entretien",                       defaultAccountNumber: "6055",   defaultTvaRate: 18, vatEligible: true,  transactionType: "depense", isHidden: false },
  { key: "transport_achat",       displayName: "Transport sur achats",                       defaultAccountNumber: "616",    defaultTvaRate: 18, vatEligible: true,  transactionType: "depense", isHidden: false },
  { key: "transport_personnel",   displayName: "Transport du personnel",                     defaultAccountNumber: "614",    defaultTvaRate: 18, vatEligible: true,  transactionType: "depense", isHidden: false },
  { key: "transport_deplacement", displayName: "Voyages et déplacements",                    defaultAccountNumber: "618",    defaultTvaRate: 18, vatEligible: true,  transactionType: "depense", isHidden: false },
  { key: "loyer",                 displayName: "Loyer / Bail",                               defaultAccountNumber: "622",    defaultTvaRate: 0,  vatEligible: false, transactionType: "depense", isHidden: false },
  { key: "entretien",             displayName: "Entretien / Réparation / Maintenance",       defaultAccountNumber: "624",    defaultTvaRate: 18, vatEligible: true,  transactionType: "depense", isHidden: false },
  { key: "assurance",             displayName: "Assurances",                                 defaultAccountNumber: "6251",   defaultTvaRate: 0,  vatEligible: false, transactionType: "depense", isHidden: false },
  { key: "telephone_internet",    displayName: "Téléphone / Internet",                       defaultAccountNumber: "6261",   defaultTvaRate: 18, vatEligible: true,  transactionType: "depense", isHidden: false },
  { key: "publicite",             displayName: "Publicité / Marketing",                      defaultAccountNumber: "6271",   defaultTvaRate: 18, vatEligible: true,  transactionType: "depense", isHidden: false },
  { key: "honoraires",            displayName: "Honoraires (comptable, avocat, conseil…)",  defaultAccountNumber: "6321",   defaultTvaRate: 0,  vatEligible: false, transactionType: "depense", isHidden: false },
  { key: "sous_traitance",        displayName: "Sous-traitance",                             defaultAccountNumber: "621",    defaultTvaRate: 18, vatEligible: true,  transactionType: "depense", isHidden: false },
  { key: "salaires",              displayName: "Salaires / Rémunérations",                   defaultAccountNumber: "661",    defaultTvaRate: 0,  vatEligible: false, transactionType: "depense", isHidden: false },
  { key: "charges_sociales",      displayName: "Charges sociales (CNPS, CFCE…)",             defaultAccountNumber: "664",    defaultTvaRate: 0,  vatEligible: false, transactionType: "depense", isHidden: false },
  { key: "impots_taxes",          displayName: "Impôts et taxes",                            defaultAccountNumber: "641",    defaultTvaRate: 0,  vatEligible: false, transactionType: "depense", isHidden: false },
  { key: "frais_bancaires",       displayName: "Frais bancaires et financiers",              defaultAccountNumber: "631",    defaultTvaRate: 18, vatEligible: true,  transactionType: "depense", isHidden: false },
  { key: "autres_achats",         displayName: "Autres achats / charges diverses",           defaultAccountNumber: "628",    defaultTvaRate: 18, vatEligible: true,  transactionType: "depense", isHidden: false },

  // ── Recettes / Produits ──────────────────────────────────────────────────
  { key: "vente_marchandises",    displayName: "Vente de marchandises",                      defaultAccountNumber: "701",    defaultTvaRate: 18, vatEligible: true,  transactionType: "recette", isHidden: false },
  { key: "vente_produits_finis",  displayName: "Vente de produits finis",                    defaultAccountNumber: "702",    defaultTvaRate: 18, vatEligible: true,  transactionType: "recette", isHidden: false },
  { key: "prestation_services",   displayName: "Prestation de services",                     defaultAccountNumber: "706",    defaultTvaRate: 18, vatEligible: true,  transactionType: "recette", isHidden: false },
  { key: "vente_travaux",         displayName: "Vente de travaux / chantiers",               defaultAccountNumber: "704",    defaultTvaRate: 18, vatEligible: true,  transactionType: "recette", isHidden: false },
  { key: "loyer_recette",         displayName: "Revenus locatifs",                           defaultAccountNumber: "708",    defaultTvaRate: 0,  vatEligible: false, transactionType: "recette", isHidden: false },
  { key: "subvention",            displayName: "Subvention d'exploitation",                  defaultAccountNumber: "711",    defaultTvaRate: 0,  vatEligible: false, transactionType: "recette", isHidden: false },
  { key: "autres_recettes",       displayName: "Autres recettes / produits divers",          defaultAccountNumber: "758",    defaultTvaRate: 0,  vatEligible: false, transactionType: "recette", isHidden: false },

  // ── Catégories système (hidden — générées automatiquement) ────────────────
  { key: "vente_carburant",       displayName: "Vente de carburant",                         defaultAccountNumber: "701",    defaultTvaRate: 18, vatEligible: true,  transactionType: "recette", isHidden: true },
  ...
  { key: "ecart_caisse_gain",     displayName: "Écart de caisse (excédent)",                 defaultAccountNumber: "758",    defaultTvaRate: 0,  vatEligible: false, transactionType: "recette", isHidden: true },
  { key: "ecart_caisse_perte",    displayName: "Écart de caisse (manquant)",                 defaultAccountNumber: "658",    defaultTvaRate: 0,  vatEligible: false, transactionType: "depense", isHidden: true },
];
